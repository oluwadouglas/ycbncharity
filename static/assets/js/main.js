(function ($) {
  ...
  /*---------- 01. On Load Function ----------*/
    ...
    $.fn.thmobilemenu = function (options) {
        var opt = $.extend(
            {
                    menuToggleBtn: ".th-menu-toggle, .mobile-menu-toggle, .mobile-menu-close",
                    bodyToggleClass: "menu-active",
        ...
        return this.each(function () {
            ...
            // Do NOT toggle the entire menu when clicking inside it.
            // Only stop propagation so outside click handlers (if any) can work.
